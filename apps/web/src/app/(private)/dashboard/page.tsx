  ...
  return (
    <div className="section grid gap-6">
      ...
      <div className="card-grid">
        <a href="/resumes" className="surface-section rounded-lg border border-secondary/50 p-5 hover:bg-secondary/10">
        ...
        <a href="/settings" className="surface-section rounded-lg border border-secondary/50 p-5 hover:bg-secondary/10">
